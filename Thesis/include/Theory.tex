...
\begin{figure}[ht]
%    \includegraphics{include/figures/mc_workflow}
...
There are two strategies that SPIN uses to reduce the number of states generated in verification.\todo{spinreferencemanualbook} The aims of them are; "to reduce the amount of reachable system states that must be searched to verify properties, or to reduce the amount of memory that is needed to store each state".
