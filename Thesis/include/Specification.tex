...
The liveness property for the system demanded a lot of revisions. As defined, a liveness property should express that \textit{eventually something good happens}. For this project this was a difficult thing to define, %since MC sucks balls and if we never OC'd everything was fine.
