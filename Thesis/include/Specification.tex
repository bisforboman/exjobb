...
From the Definition~\ref{def:OverColl} we understnd it's not uncommon for processes to collect more data than they require. A single sensor node usually\cite{WSN_a_survey} doesn't hold the information of the entire system state.
